...
const images = [stylerOil];
const videos = [video1, video2, video3];

export default function OrderPackSoinComplet() {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <motion.div className="space-y-4" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2, duration: 0.6, ease: "easeOut" }}>
          <motion.div className="relative overflow-hidden border-2 border-orange-100 shadow-lg p-2 sm:p-4 bg-gradient-to-br from-gray-50 to-white rounded-xl product-image-container flex justify-center items-center max-w-[80%] mx-auto aspect-square" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3, duration: 0.5, ease: "easeOut" }}>
            <img src={images[0]} alt="Pack Soin Complet" className="absolute inset-0 m-auto w-[112%] h-[112%] object-contain rounded-lg" />
          </motion.div>
        </motion.div>
        ...
        <motion.div className="space-y-6" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.6, ease: "easeOut" }}>
          <div>
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-2">
              ...
              <motion.h1 className="text-2xl sm:text-3xl font-bold text-black text-center lg:text-left" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.5, ease: "easeOut" }}>Pack « Soin Complet »</motion.h1>
              <Sparkles className="w-5 h-5 text-orange-500" />
            </div>
          ...
          <div className="flex items-center justify-center lg:justify-start gap-4">
            <span className="text-lg text-gray-400 line-through">154,99 $</span>
            <span className="text-3xl font-bold text-orange-600">149,99 $ CAD</span>
          </div>

          {/* Product Description */}
          <div className="text-gray-700 text-base leading-relaxed mb-2 text-center lg:text-left">
            <p className="mb-1 font-bold">A complete care solution for your hair routine.</p>
            <p className="mb-1">1 Styler 5 en 1 + 1 Élixir</p>
            <p className="mb-1">This pack combines our versatile styler with a nourishing elixir for maximum shine and health.</p>
          </div>
